 ...
 */
 ...
 var canUseBlob = (typeof Blob !== 'undefined') && URL && typeof URL.createObjectURL === 'function';
 if (canUseBlob) {
 isObjectURL = true;
 ...
 // WeChat MiniProgram compatibility: no Blob in some runtimes.
 var uint8 = new Uint8Array(bufferView);
 var b64 = '';
 if (typeof wx !== 'undefined' && wx.arrayBufferToBase64) {
 b64 = wx.arrayBufferToBase64(uint8.buffer);
 } else {
 var binary = '';
 for (var i = 0; i < uint8.length; i++) binary += String.fromCharCode(uint8[i]);
 b64 = (typeof btoa !== 'undefined') ? btoa(binary) : '';
 }
 var mime = source.mimeType || 'application/octet-stream';
 sourceURI = 'data:' + mime + ';base64,' + b64;
 isObjectURL = false;
 return sourceURI;
